...
$request = json_decode($postdata);
        ...
        else if((strlen($aula) <= 3) || (strlen($aula) >= 5)) 
        {
             $data["datos"] =array("info" => "Espacio no valido", "estatus" => 2);
             header('Content-Type: application/json');
             echo json_encode($data);
        }

        else if (($subcadenas[0] == "A") && (($subcadenas[1] < MIN_CLASSROOM) || ($subcadenas[1] > MAX_A_CLASSROOM)) && $espacio == 'Aula') {

             $data["datos"] =array("info" => "El aula seleccionada no es válida. El módulo ".$subcadenas[0]." sólo comprende las aulas ". MIN_CLASSROOM ." - $aula ". MAX_A_CLASSROOM .".", "estatus" => 2);
             header('Content-Type: application/json');
             echo json_encode($data);

        }

         else if (($subcadenas[0] == "C") && (($subcadenas[1] < MIN_CLASSROOM) || ($subcadenas[1] > MAX_C_CLASSROOM)) && $espacio == 'Aula') {
         ...
         else if (($subcadenas[0] == "D") && (($subcadenas[1] < MIN_CLASSROOM) || ($subcadenas[1] > MAX_D_CLASSROOM)) && $espacio == 'Aula') {
         ...
         else if (($subcadenas[0] == "E") && (($subcadenas[1] < MIN_CLASSROOM) || ($subcadenas[1] > MAX_E_CLASSROOM))) {
