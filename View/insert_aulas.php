...
<?php
    ...
    ?>
      <div style='background-color:#33bdca; color:white; text-align: center'>
        <h5  class='modal-title' id='exampleModalLabel'>REGISTRO DE AULAS PARA <?php echo strtoupper($_SESSION['university_center'])?></h5>       
      </div>
            ...
            <div class='container'>
                ...
                <div class = 'row' >
                  ...
                  <div class='col-7'>
                          ...
                          <br><br><label><input ng-model='myCheckbox' ng-change='autoFill(6)' type='checkbox' id='cbox1' value='first_checkbox'> Autocompletar</label><br>          
                  </div>
                  </div>
                  <hr>
                  <div class = 'row' >
                  ...
                  <div class='row'>
                    ...
                    <div class='col-sm-3'>
                      <br>
                                ...
                                <select id="id_aulas" style='border-color: #a4a4a4; border-style:solid; border-width: 2px;'  ng-model='user.edificio' required>
                    ...
                    <div class='col-sm-3'>
                     ...
                     <div class='col-sm-3'>
                      <br>
                                ...
                                <select id="id_salones" style='border-color: #a4a4a4; border-style:solid; border-width: 2px;'  ng-model='user.numero_salon' required>
