            ...
            <div class='container'>
                  ...
                  <div class = 'row'>
                    <div class= 'col-sm-12'>
                      <div>
                            <p>
                                <br><label for='id_dependencia'style='color:#283b41'><strong>DEPENDENCIA</strong></label><br>
                                <select style='border-color: #a4a4a4; border-style:solid; width:100%; border-width: 2px; id='id_dependencia' name='dependencia' ng-model='user.dependencia' onchange="if(this.value=='Otro') document.getElementById('otro').disabled=false; else if(this.value!='Otro') document.getElementById('otro').disabled=true;" required>
                                    <option value='' name='dependencia' selected>Seleccionar</option>
                  ...
                  <div class = 'row' >
                    <div class = 'col-sm-12'>
                        ...
                        <input style='border-style: solid;border-color: #a4a4a4; width:100%' type='text' id='id_tel_organizador' name='tel_organizador' required minlength='"<?php echo MIN_PHONE_LENGTH ?>"' maxlength='"<?php echo MAX_PHONE_LENGTH?>"' ng-model='user.tel_organizador' placeholder='Extensión/Celular' />
                    </div>
                ...
                <div class = 'row' >
                  ...
                  <div class='col-7'>
                          ...
                          <br><br><label><input ng-model='myCheckbox' ng-change='autoFill(5)' type='checkbox' id='cbox1' value='first_checkbox'> Autocompletar</label><br>          
                  </div>
                  </div>
                  <hr>
                  <div class = 'row' >
